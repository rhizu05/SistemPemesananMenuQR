...
<head>
    ...
    <title>Verifikasi OTP Login - Dapoer Katendjo</title>
...
<body>
    <div class="otp-card">
        <div class="otp-header">
            ...
            <p>Masukkan kode OTP untuk login</p>
        </div>

        <div class="otp-body">
            <div class="info-box">
                Kode OTP telah dikirim ke nomor <strong>{{ session('login_phone') }}</strong> via WhatsApp
            </div>
