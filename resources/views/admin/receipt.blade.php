...
<body>
    <div class="receipt">
        ...
        <div class="subtotal">
            <p><span>Subtotal:</span> <span>Rp {{ number_format($order->total_amount / 1.1, 0, ',', '.') }}</span></p>
            <p><span>Pajak (10%):</span> <span>Rp {{ number_format($order->total_amount * 0.1 / 1.1, 0, ',', '.') }}</span></p>
        </div>
